...
export default class Pagination {
    constructor (ul, opt) {
        ...
        this.prevStr = ` <li class="prev"><a>${this.opt.prevContent}</a></li>`
        this.nextStr = ` <li class="next"><a>${this.opt.nextContent}</a></li>`
    ...
    getLi () {
        ...
        this.liStr += `<li class="pagination-item" data-page="1"><a>1</a></li>`
        let _liItem = ''
        for (let i = start; i <= end; i++) {
            _liItem += `<li class="pagination-item" data-page="${i}"><a>${i}</a></li>`
        }
        if (start === 2) {
        ...
        this.liStr += `<li class="pagination-item" data-page="${this.pageCount}"><a>${this.pageCount}</a></li>`
    }
