 ...
 */
import {pageLoadingHide, axiosAjax, proxyUrl, fomartQuery, getHourMinute, sevenDays, showLogin, add0} from './public/public'
        ...
        arr.map((item) => {
            ...
            str += `<li class="flash-news">
                <div class="news-item">
                    ...
                    ${cont}
                    ${!item.url ? '' : `<a data-url="${item.url}" href="javascript:void(0)" style="color: #1482f0" target="_blank"> 「查看原文」</a>`}
