    ...
    renderInfo (particularsCont) {
        ...
        <div class="currency-title">
            ...
            <div class="official">
                <p>官方网站：</p>
                <span>
                    <a href="${websites[0]}" target="_blank">${!websites[0] ? '暂无信息' : websites[0]}</a>
                </span>
                <span>
                    <a target="_blank" href="${websites[1]}">${websites[1]}</a>
                </span>
            </div>
            <div class="block">
                <p>区块站：</p>
                <span>
                    <a href="${explorer[0]}" target="_blank">${!explorer[0] ? '暂无信息' : explorer[0]}</a>
                </span>
                <span>
                    <a target="_blank" href="${explorer[1]}">${explorer[1]}</a>
                </span>
            </div>
        `
